...
include('../config/DbFunction.php');
	...
	if(isset($_POST['submit'])){
     ...
     $obj->register($_POST['course-short'],$_POST['c-full'],$_POST['roll_no'],$_POST['fname'],$_POST['mname'],$_POST['lname'],$_POST['gender'],
     	            $_POST['gname'],$_POST['ocp'],$_POST['income'],$_POST['category'],$_POST['nation']
...
<option VALUE="">SELECT</option>
		...
		<div class="col-lg-6">
 <input class="form-control" name="c-full"  type="varchar" autocomplete="off">
       </select>
	</div>
	 </div>	
	 ...
	 <br><br>								
			...
			<div class="form-group">
		<div class="col-lg-4">
		<label>Complete Session<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
		
	   <input type="text "class="form-control" name="session" placeholder="2019-2022" >
	 </div>	
	...
	<br><br>		
			...
			<div class="col-lg-4">
			<input type="text" class="form-control" name="income"  id="income"required="required" pattern="[0-9]+$">
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<br><br><br><br>		
        ...
        <option value="">Select City</option>
			...
			<div class="col-lg-4">
			<textarea class="form-control" rows="3" name="padd" id="padd" required></textarea>
			</div>
			</div>	
			<br><br><br><br>
